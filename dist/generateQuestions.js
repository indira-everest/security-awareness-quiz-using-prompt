...
export async function generateQuestions(prompt, outputPath) {
    ...
    try {
        const response = await ai.models.generateContent({
            ...
            config: {
                temperature: 0.7,
                systemInstruction: "You are an expert CSV generator. You MUST return ONLY the requested CSV content and nothing else. Ensure the column headers are the first row and are quoted correctly.",
            },
        });
